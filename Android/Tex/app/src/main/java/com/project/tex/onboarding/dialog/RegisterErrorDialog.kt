...
import com.project.tex.databinding.DialogRegErrorInfoBinding
...
class RegisterErrorDialog : BaseDialog<DialogRegErrorInfoBinding>(), View.OnClickListener {
    override fun getViewBinding() = DialogRegErrorInfoBinding.inflate(layoutInflater)

    fun showDialog(manager: FragmentManager) {
        val fragment = RegisterErrorDialog()
        val args = Bundle()
